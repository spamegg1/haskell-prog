-- Q 30.2
-- Why can’t you write a function like creditsFromId to solve this problem?
...
-- Answer:
-- You have no way of getting a value out of an IO context as you do a Maybe
-- context. You need more powerful tools such as Applicative and Functor to work
-- with IO types.
